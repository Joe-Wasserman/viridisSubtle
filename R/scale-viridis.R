...
#'
scale_colour_viridis_d <- function(..., alpha = 1, begin = 0, end = 1, subtle = FALSE,
                                   direction = 1, option = "D", aesthetics = "colour") {
  discrete_scale(
    aesthetics,
    "viridis_d",
    viridis_pal(alpha, begin, end, subtle, direction, option),
    ...
  )
}
...
#' @export
#' @rdname scale_viridis
scale_fill_viridis_d <- function(..., alpha = 1, begin = 0, end = 1, subtle = FALSE,
...
#' @export
#' @rdname scale_viridis
scale_colour_viridis_b <- function(..., alpha = 1, begin = 0, end = 1, subtle = FALSE,
  ...
  binned_scale(
    ...
    "viridis_b",
    gradient_n_pal(
      viridis_pal(alpha, begin, end, subtle, direction, option)(6),
      values,
      space
    ),
    na.value = na.value,
...
#' @export
#' @rdname scale_viridis
scale_fill_viridis_b <- function(..., alpha = 1, begin = 0, end = 1, subtle = FALSE,
                                 direction = 1, option = "D", values = NULL,
                                 space = "Lab", na.value = "grey50",
